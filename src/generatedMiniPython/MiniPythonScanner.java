// Generated from /Users/jochaes/Documents/Repositorios/Compiladores/AlphaCompiler/Proyecto1G4/MiniPythonScanner.g4 by ANTLR 4.12.0
...
public class MiniPythonScanner extends Lexer {
	...
	public static final int
		...
		IN=25, DEF=26, IF=27, WHILE=28, FOR=29, ELSE=30, DO=31, CONST=32, VAR=33, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"WHILE", "FOR", "ELSE", "DO", "CONST", "VAR", "RETURN", "PRINT", "LEN", 
			"IDENTIFIER", "INTEGER", "FLOAT", "CHARCONST", "STRING", "LETTER", "DIGIT", 
			"NEWLINE", "WS", "LINECOMMENT", "COMMENT"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'\"'", "'''", "'+'", "'-'", "'*'", "'/'", "'='", "'-='", "'+='", "'<'", 
			"'>'", "'<='", "'>='", "'=='", "'in'", "'def'", "'if'", "'while'", "'for'", 
			"'else'", "'do'", "'const'", "'var'", "'return'", "'print'", "'len'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"GREATERTHAN", "LESSTHANEQUAL", "GREATERTHANEQUAL", "COMPARISON", "IN", 
			"DEF", "IF", "WHILE", "FOR", "ELSE", "DO", "CONST", "VAR", "RETURN", 
